...
module.exports = {
  ...
  emparejarMovimiento,
  normalizarTexto,
  // Exportados para que otros importadores de CSV del proyecto (ej. el
  // PUC personalizado por cliente, en server.js) reutilicen el mismo
  // parser de filas -- en vez de escribir un segundo parser de comillas/
  // separadores que con el tiempo se desincronice de este.
  parsearFilasCSV,
